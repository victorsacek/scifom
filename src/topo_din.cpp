...
//os intervals de tempo estao no arquivo param_topo_din.txt (a primeira linha È o numero de intvalos de tempo
//  Created by LabTectonofisica on 30/04/18.
//  Copyright (c) 2018 Lab Tectonof√≠sica. All rights reserved.
//
